...
class dsbsc(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "dsbsc", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("dsbsc")
        ...
        self.low_pass_filter_0 = filter.fir_filter_fff(
            ...
            firdes.low_pass(
                ...
                window.WIN_HAMMING,
                6.76))
        self.blocks_wavfile_source_0 = blocks.wavfile_source('/home/tanisha/Downloads/lab_1_resources/lab_1/vocal.wav', True)
