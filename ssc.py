...
class ssc(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "ssc")
        ...
        self.analog_sig_source_x_0_1 = analog.sig_source_f(samp_rate, analog.GR_SIN_WAVE, 10000, 1, 0, 0)
        self.analog_sig_source_x_0_0 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, 200000, 1, 0, 0)
        ...
        self.connect((self.analog_sig_source_x_0_2, 0), (self.blocks_multiply_xx_1, 0))
        ...
        self.connect((self.blocks_multiply_xx_0, 0), (self.blocks_sub_xx_1, 0))
        self.connect((self.blocks_multiply_xx_0_0, 0), (self.blocks_add_xx_0, 1))
        self.connect((self.blocks_multiply_xx_0_0, 0), (self.blocks_sub_xx_1, 1))
        self.connect((self.blocks_multiply_xx_1, 0), (self.low_pass_filter_0, 0))
        self.connect((self.blocks_sub_xx_1, 0), (self.qtgui_freq_sink_x_0_2, 0))
...
def main(top_block_cls=ssc, options=None):
